...
- Run IDE with the plugin: `cd secrux-intellij-plugin && ../gradle-8.10.2/bin/gradle runIde`
- Build plugin ZIP: `cd secrux-intellij-plugin && ../gradle-8.10.2/bin/gradle buildPlugin`
...
- Sink catalog: built-in list or project custom JSON file (see `secrux-intellij-plugin/docs/sink-catalog.example.json`)
...
- `secrux-intellij-plugin/docs/README.md`
- `secrux-intellij-plugin/docs/ARCHITECTURE.md`
- `secrux-intellij-plugin/docs/TECH_SELECTION.md`
- `secrux-intellij-plugin/docs/SECRUX_INTEGRATION.md`
- `secrux-intellij-plugin/docs/ROADMAP.md`
